...
class EditReceita extends StatefulWidget {

  final Receita _receita;

  EditReceita(this._receita);

  @override
  _EditReceitaState createState() => _EditReceitaState(_receita);
}

class _EditReceitaState extends State<EditReceita> {
  final Receita _receita;
  final TextEditingController _observacoesController = TextEditingController();
  final TextEditingController _valorController = TextEditingController();

  _EditReceitaState(this._receita){
    _tipoDeReceitaController = _receita.tipo.id;
    _dataValue = _receita.dataHora;
    _observacoesController.text = _receita.observacoes;
    _valorController.text = _receita.valor.toString();
  }
    ...
    return FloatingActionButton(
      ...
      onPressed: () {
        ...
        final newReceita = Receita(
          _receita.id, _observacoesController.text, dataHora, valor,
          TipoReceita(id: _tipoDeReceitaController)
        );
        if(newReceita.valido()) {
          ReceitaContoller.update(newReceita)
  ...
  renderForm(){
    return Scaffold(
      appBar: AppBar(
        title: const Text('Editando Receita'),
      ),
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: DropdownButton(
                        ...
                        onChanged: (idNewTipo) {
                          setState((){
                            _tipoDeReceitaController = idNewTipo;
                          });
                        },
